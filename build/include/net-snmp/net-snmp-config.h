...
#define NETSNMP_CONFIGURE_OPTIONS " '--build=x86_64' '--host=arm-linux-uclibc' '--prefix=/usr/local' '--with-install-prefix=/home/florian/src/1_berofixfs/app/arm/work/target-full' '--with-default-snmp-version=2' '--with-sys-contact=contact' '--with-sys-location=location' '--with-logfile=/tmp/snmpd.log' '--with-persistent-directory=/usr/conf/' '--disable-applications' '--disable-manuals' '--disable-scripts' '--disable-mibs' '--disable-mib-loading' '--disable-snmpv1' '--disable-debugging' '--disable-deprecated' '--enable-mini-agent' '--with-perl-modules=no' '--disable-embedded-perl' '--enable-static=no' '--with-out-mib-modules=smux,snmpv3mibs,mibII/snmp_mib,mibII/system_mib,mibII/sysORTable,mibII/vacm_vars' '--with-mib-modules=BEROFIX-MIB/berofixManufacturer BEROFIX-MIB/berofixSerial BEROFIX-MIB/berofixRevision BEROFIX-MIB/berofixRootVersion BEROFIX-MIB/berofixAppVersion BEROFIX-MIB/berofixFPGAVersion BEROFIX-MIB/berofixLineInterfaceTable/berofixLineInterfaceTable BEROFIX-MIB/berofixNetworkTable/berofixNetworkTable BEROFIX-MIB/berofixSystemUptime BEROFIX-MIB/berofixISGWUptime BEROFIX-MIB/berofixStatisticsCallsTable/berofixStatisticsCallsTable BEROFIX-MIB/berofixStatisticsL1ErrorTable/berofixStatisticsL1ErrorTable BEROFIX-MIB/berofixStatisticsL2ErrorTable/berofixStatisticsL2ErrorTable BEROFIX-MIB/berofixReboot BEROFIX-MIB/berofixCPUusageTable/berofixCPUusageTable BEROFIX-MIB/berofixRAMusageTable/berofixRAMusageTable BEROFIX-MIB/berofixStatisticsISDNStateTable/berofixStatisticsISDNStateTable BEROFIX-MIB/berofixStatisticsPortStatTable/berofixStatisticsPortStatTable BEROFIX-MIB/berofixStatisticsSIPRegTable/berofixStatisticsSIPRegTable' 'build_alias=x86_64' 'host_alias=arm-linux-uclibc' 'CC=arm-linux-uclibc-gcc' 'CFLAGS=' 'LDFLAGS=' 'CPP=arm-linux-uclibc-cpp'"
...
#define NETSNMP_DEFAULT_MIBS ":BEROFIX-MIB:SNMPv2-MIB:RFC1213-MIB"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/usr/conf/"
...
#define NETSNMP_SYS_CONTACT "contact"

/* system location */
#define NETSNMP_SYS_LOC "location"
